...
- Data preprocessing : `MovingPandas` [@0x003aba2b] provide trajectory data structures and functions for data exploration and visualization.  `scikit-mobility` is a library that allow for managing and generate synthetic mobility data of various formats. `PTRAIL` is a library for mobility data preprocessing especially in feature generation and trajectory interpolation. `traffic` [@Olive2019] is a toolbox for processing and analyzing air traffic data. 
