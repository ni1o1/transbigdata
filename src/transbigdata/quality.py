...
def data_summary_en(data,col = ['Vehicleid','Time'],show_sample_duration = False,roundnum = 4):
    '''
    English version
    输入数据，打印数据概况
    ...
    print('Mean value of individual data items:',round(Vehicleid_count.mean(),roundnum))
    print('Upper quartile of individual data items:',round(Vehicleid_count.quantile(0.75),roundnum))
    print('Median volume of individual data items:',round(Vehicleid_count.quantile(0.5),roundnum))
    print('Lower quartile of individual data items:',round(Vehicleid_count.quantile(0.25),roundnum))
    print('')
    ...
    if show_sample_duration:
        sd = sample_duration(data, col=[Vehicleid, Time])
        print('Individual sampling interval')
        print('-----------------')
        print('Mean value:',round(sd['duration'].mean(),roundnum),'seconds')
        print('Upper quartile:',round(sd['duration'].quantile(0.75),roundnum),'seconds')
        print('Median:',round(sd['duration'].quantile(0.5),roundnum),'seconds')
        print('Lower quartile:',round(sd['duration'].quantile(0.25),roundnum),'seconds')