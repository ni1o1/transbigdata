...
class TestCoordinatesConverter:
    ...
    def test_CoordinatesConverter(self):
        ...
        lon,lat = tbd.bd09mctobd09(self.data['LONGITUDE'],self.data['LATITUDE'])
        assert np.allclose([lon.iloc[0],lat.iloc[0]],[0.0010908419148962093, 0.00028151894107858114])
        assert tbd.getdistance(121.432966, 31.130154, 121.442523, 31.128701) == 923.9008993249727
