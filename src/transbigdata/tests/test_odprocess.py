...
class TestODprocess:
    def setup_method(self):
        self.data = pd.DataFrame([
            ...
            columns=['VehicleNum',
                     ...
                     'OpenStatus',
                     'Speed'])
        self.sz = gpd.GeoDataFrame([
            Polygon(
                [[113.74627986426263, 22.39928709355355],
                 [113.74627986426263, 22.864719035968925],
                 [114.62397036947118, 22.864719035968925],
                 [114.62397036947118, 22.39928709355355]])],
            columns=['geometry'])
    ...
    def test_odprocess(self):
        ...
        assert len(tbd.traj_sparsify(
            data, col=['VehicleNum', 'time', 'slon', 'slat'],
        ...
        data['count'] = 1
        assert tbd.dataagg(data, self.sz, col=['slon', 'slat', 'count'],
                           accuracy=500)[0]['count'].iloc[0] == 19
